...
export const SET_STATUS_ADD_CONFIRMATION = "SET_STATUS_ADD_CONFIRMATION";
...
export const setMechanicName = mechanicName => ({
...
export const setStatusAddConfirmation = statusAddConfirmation => ({
    type: SET_STATUS_ADD_CONFIRMATION,
    payload: statusAddConfirmation
});
